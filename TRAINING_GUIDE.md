...
- `--eval-ratio`: Ratio of data for evaluation (default: 0.2)
...
### Wandb
- `--wandb-mode`: Wandb logging mode - `online`, `offline`, or `disabled` (default: `offline`)
...
- Start with `--wandb-mode offline` to test locally
